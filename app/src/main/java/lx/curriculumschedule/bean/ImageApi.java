...
public class ImageApi {
    ...
    public static class ImagesBean {
         ...
         * copyrightlink : http://www.bing.com/search?q=æ¯å£«è¾¾å·æ³&form=hpcapt&mkt=zh-cn
         * title :
         * quiz : QUIZ
         * wp : false
